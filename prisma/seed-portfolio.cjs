...
async function main() {
  ...
  await prisma.settings.create({
    data: {
      ...
      aboutText: "Lulusan S1 Teknik Informatika dari Universitas Komputer Indonesia (UNIKOM) dengan IPK 3.46 dan fokus utama pada Quality Assurance, IT Business Analysis, dan System Analysis. Mahir dalam pengujian manual (manual testing) untuk platform web dan seluler, analisis kebutuhan bisnis, serta pemodelan sistem menggunakan DFD, ERD, dan flowchart. Memiliki pengalaman kepemimpinan sebagai Ketua Himpunan Mahasiswa (HMIF UNIKOM), serta keahlian komunikasi, kolaborasi, dan pemecahan masalah yang kuat. Sangat analitis, teliti, dan adaptif dalam lingkungan kerja dinamis.",
      aboutTextEn: "Informatics Engineering graduate from Universitas Komputer Indonesia (UNIKOM) with a 3.46 GPA and a core focus on Quality Assurance, IT Business Analysis, and System Analysis. Proficient in manual testing for web and mobile platforms, business requirement analysis, and system modeling using DFD, ERD, and flowcharts. Experienced leader with a proven track record as Chairperson of HMIF UNIKOM, demonstrating strong skills in communication, collaboration, and problem-solving.",
  ...
  await prisma.project.createMany({
    data: [
      ...
      },
      {
        ...
        imageUrl: "/projects/fintrack-dashboard.png,/projects/fintrack-login.png",
      ...
      },
      {
        ...
        imageUrl: "/projects/silesin-dashboard.png,/projects/silesin-login.png",
