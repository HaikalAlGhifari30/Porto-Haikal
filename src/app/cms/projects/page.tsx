        ...
        <div className="space-y-6">
            <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 mb-10">
                <div className="flex-1">
                    <h2 className="text-2xl md:text-3xl font-black tracking-tight text-slate-900 dark:text-white uppercase font-serif">Manajemen Proyek</h2>
                    <p className="text-sm text-slate-500 dark:text-zinc-400 mt-2 font-medium leading-relaxed max-w-2xl">
                        Susun portofolio karya terbaik Baroedak COMO dan atur urutan tampilannya di landing page.
                    </p>

                    {/* Project Ordering Tutorial */}
                    <div className="mt-6 flex items-center gap-4 p-5 rounded-[1.5rem] bg-blue-500/[0.03] dark:bg-blue-500/[0.02] border border-blue-500/10 animate-in fade-in slide-in-from-top-1 duration-500">
                ...
                <div className="shrink-0 lg:mt-2 flex justify-end">
                    <ProjectFormToggle />
                </div>
            </div>
