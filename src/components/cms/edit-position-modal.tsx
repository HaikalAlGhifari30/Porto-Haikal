            ...
            <DialogContent className="sm:max-w-md bg-white dark:bg-zinc-950 border-slate-200 dark:border-zinc-800 rounded-[2.5rem] p-8 !backdrop-blur-xl">
                ...
                <form action={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <Button type="submit" className="flex-1 h-12 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-lg shadow-blue-500/20">Perbarui Posisi</Button>
                    </div>
                </form>
            </DialogContent>
        </Dialog>
