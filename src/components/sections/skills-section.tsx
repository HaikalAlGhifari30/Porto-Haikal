...
export function SkillsSection({ skills = [] }: SkillsSectionProps) {
  ...
  return (
    <section id="skills" className="py-24 relative overflow-hidden bg-transparent text-zinc-900 dark:text-white transition-colors duration-500">
      {/* Background Gradients */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-blue-500/5 dark:bg-cyan-500/10 rounded-full blur-[140px] pointer-events-none" />
